...
| Changes public API of any declared-public module (the Iron Law #6 surface: `Qx`, `Qx.QuantumCircuit`, `Qx.Operations`, `Qx.Simulation`, `Qx.SimulationResult`, `Qx.Qubit`, `Qx.Register`, `Qx.StateInit`, `Qx.Patterns`, `Qx.Math`, `Qx.Hardware`, `Qx.Hardware.Config`, `Qx.Export.OpenQASM`, `Qx.Draw`, `Qx.Behaviours.*`) | +3 |
