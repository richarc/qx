defmodule Qx.Export.OpenQASM.AST do
  ...
  # AST node shapes produced by `Qx.Export.OpenQASM.Parser` and consumed by
  # `Qx.Export.OpenQASM.Lowering` and `Qx.Export.OpenQASM.Codegen`. Kept as a
  # maintainer reference (this module is internal; no public docs).
  #
  # Nodes are tagged tuples. Every node carries a 1-based `:line` (and where
