defmodule Qx.Qubit do
  # Internal calc engine (single-qubit wrapper around Qx.Register).
  ...
  This function visualizes the qubit's state on the Bloch sphere, showing
  the state vector, axes, and key basis states.
