defmodule Qx.CalcTest do
  ...
  describe "apply_single_qubit_gate/4" do
    ...
    test "applies gate to first qubit in 2-qubit system" do
      # Start with |00⟩
      state =
        Nx.tensor([C.new(1.0, 0.0), C.new(0.0, 0.0), C.new(0.0, 0.0), C.new(0.0, 0.0)],
          type: :c64
        )
      ...
      # X on qubit 0: |00⟩ -> |10⟩
      expected =
        Nx.tensor([C.new(0.0, 0.0), C.new(0.0, 0.0), C.new(1.0, 0.0), C.new(0.0, 0.0)],
          type: :c64
        )
    ...
    test "applies gate to second qubit in 2-qubit system" do
      ...
      # X on qubit 1: |00⟩ -> |01⟩
      expected =
        Nx.tensor([C.new(0.0, 0.0), C.new(1.0, 0.0), C.new(0.0, 0.0), C.new(0.0, 0.0)],
          type: :c64
        )
  ...
  describe "apply_cnot/4" do
    ...
    test "CNOT on |10⟩ gives |11⟩" do
      ...
      expected =
        Nx.tensor([C.new(0.0, 0.0), C.new(0.0, 0.0), C.new(0.0, 0.0), C.new(1.0, 0.0)],
          type: :c64
        )
