...
svg1 = Qx.draw_circuit(qc1, "Conditional X Gate (c0==1)").svg
...
svg2 = Qx.draw_circuit(qc2, "Conditional Z Gate (c0==0)").svg
...
svg3 = Qx.draw_circuit(qc3, "Multiple Conditional Gates").svg
...
svg4 = Qx.draw_circuit(qc4, "Quantum Teleportation Protocol").svg
...
svg5 = Qx.draw_circuit(qc5, "Multiple Classical Controls").svg
